...
public class DASHMyPageVO {
	...
	private List<DASHMyPageVO> studentList;
	...
	public List<DASHMyPageVO> getStudentList() {
		return studentList;
	}

	public void setStudentList(List<DASHMyPageVO> studentList) {
